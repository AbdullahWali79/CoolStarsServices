...
const Header = () => {
  return (
    <div className='relative bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 rounded-2xl px-4 sm:px-6 md:px-10 lg:px-20 overflow-hidden shadow-2xl'>
      
      {/* Background Pattern */}
      <div className='absolute inset-0 bg-black/10'></div>
      
      {/* Trust Badge */}
      <div className='absolute top-3 sm:top-6 right-3 sm:right-6 bg-white/20 backdrop-blur-sm rounded-full px-4 sm:px-6 py-2.5 sm:py-3 z-10'>
      ...
      <div className='relative flex flex-col md:flex-row items-center'>
        {/* -------- Left Side - Content -------- */}
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-3 sm:gap-4 py-6 sm:py-8 md:py-16 lg:py-20 text-white'>
          ...
          {/* Subheadline */}
          <p className='text-sm sm:text-base md:text-lg text-blue-100 leading-relaxed max-w-lg'>
          ...
          <div className='flex flex-col sm:flex-row gap-3 w-full'>
            <a
              ...
              className='flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 text-white px-5 sm:px-6 py-3 rounded-xl text-base font-semibold hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl'
            >
              📱 Book on WhatsApp
            ...
            <a
              ...
              className='flex items-center justify-center gap-3 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white px-5 sm:px-6 py-3 rounded-xl text-base font-semibold transition-all duration-300 border border-white/30'
            >
              📞 Call Now
            </a>
          </div>
          ...
          <div className='grid grid-cols-3 gap-3 sm:gap-4 pt-4 border-t border-white/20'>
            <div className='text-center'>
              ...
              <div className='text-[10px] sm:text-xs text-blue-100'>Response Time</div>
            </div>
            <div className='text-center'>
              <div className='text-lg sm:text-xl font-bold text-yellow-300'>95%</div>
              <div className='text-[10px] sm:text-xs text-blue-100'>Success Rate</div>
            </div>
            <div className='text-center'>
              <div className='text-lg sm:text-xl font-bold text-yellow-300'>24/7</div>
              <div className='text-[10px] sm:text-xs text-blue-100'>Available</div>
            </div>
          </div>
        </div>
        ...
        <div className='md:w-1/2 w-full flex justify-center md:justify-end'>
          <div className='relative w-full max-w-md sm:max-w-lg'>
            <img
              ...
              className='w-full h-auto max-h-[420px] sm:max-h-[500px] object-cover object-center rounded-xl shadow-xl'
            />
